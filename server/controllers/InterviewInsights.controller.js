...
export const HandleCreateInterview = async (req, res) => {
    try {
        ...
        const interview = await Interviewinsight.findOne({ applicant: applicantID })
...
export const HandleAllInterviews = async (req, res) => {
    try {
        const interviews = await Interviewinsight.find({}).populate("applicant interviewer", "firstname lastname email")
...
export const HandleInterview = async (req, res) => {
    try {
        ...
        const interview = await Interviewinsight.findById(interviewID).populate("applicant interviewer", "firstname lastname email")
        if (!interview) {
