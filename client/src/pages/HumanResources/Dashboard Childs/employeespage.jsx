...
export const HREmployeesPage = () => {
    ...
    return (
        <div className="employee-page-content w-full mx-auto my-10 flex flex-col gap-5 h-[94%]">
            <div className="employees-heading flex justify-between items-center min-[250px]:pe-4 md:pe-9">
            ...
            <div className="employees-data flex flex-col gap-4 pe-5 overflow-auto">
                <ListWrapper>
                    <HeadingBar table_layout={"grid-cols-5"} table_headings={table_headings} />
                </ListWrapper>
                <ListContainer>
                    <ListItems HREmployeeState={HREmployeesState} />
                </ListContainer>
            </div>
        </div>
    )
